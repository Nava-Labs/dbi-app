...
export default function PrivateChat(props: any) {
     const { user, accountAddr, signer, privateChatId, organizations, hackerAddr, groupChats } = props
     // console.log("wawawa", accountAddr)
     // const [message, setMessage] = useState("");
     // const [groupChats, setGroupChats] = useState<any>();
     useEffect(()=>{
          console.log("wewew")
     },[accountAddr, privateChatId])
     // useEffect(() => {
     //      console.log("dsajlkdjasifjdsilajfidls")
     ...
     //           console.log("chat chat ", groupChats)
     ...
     //      })
     //      currentChat = formatGroupChats(currentChat, orgsAdmins);
